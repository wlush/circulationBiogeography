...
!!--------------------------------------------------------------------------  
   ...
   CASE (1)
      ...
      !cwgl edit: added +1 to capture edges
      imt = subGridImax-subGridImin +1
      jmt = subGridJmax-subGridJmin +1
      
      !cwgl edit to fix seeding on subgrid:
      ! (for boxes)
      ist1 = ist1 - subGridImin +1
      ist2 = ist2 - subGridImin +1
      jst1 = jst1 - subGridJmin +1
      jst2 = jst2 - subGridJmin +1
      ! end cwgl edit
