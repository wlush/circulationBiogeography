            ...
            CASE(1)
               DO jsd = 1,nsdMax
                  READ (unit=34, fmt=ijkform) seed_ijk(jsd,1), &
                                              ...
                                              seed_set(jsd,2)
               END DO
               !cwgl - fixed subgrid seedlist issue...
               DO jsd = 1,nsdMax
                  seed_ijk(jsd,1) = (seed_ijk(jsd,1)-subGridImin)+1
                  seed_ijk(jsd,2) = (seed_ijk(jsd,2)-subGridJmin)+1
                  !k is currently excluded; will update if necessary
               END DO
               !cwgl end
